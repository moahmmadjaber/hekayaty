...
class _CafeteriaPageState extends State<CafeteriaPage> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<CafeteriaCubit,CafeteriaState>(listener: (context,state){},child: content(),);
  }
  Widget content(){
    return
        Scaffold(backgroundColor: MyColor.lowGray,
          appBar: AppBar(centerTitle: true,
            title: Text('الكافتريا',style: TextStyle(color: MyColor.colorWhite,),),
          ),
          body:
          ListView(
            ...
            children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  InkWell(
                    onTap: () => CafeteriaPrinter.printCafeteriaInvoice(items),
