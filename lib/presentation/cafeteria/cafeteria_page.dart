...
import 'package:hekayaty/presentation/app_resources/printing/cafeteria.dart';
...
class CafeteriaPage extends StatefulWidget {
  ...
  const CafeteriaPage({super.key, required this.item});
...
class _CafeteriaPageState extends State<CafeteriaPage> {
  ...
  late CafeteriaCubit bloc;
  @override
  void initState() {
bloc=BlocProvider.of<CafeteriaCubit>(context);
bloc.getSubCategory(widget.item.id!);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<CafeteriaCubit, CafeteriaState>(
        listener: (context, state) {
          ...
          if (state is OrderComplete) {
            CafeteriaPrinter.printCafeteriaInvoice(
              context,
        ...
        builder: (BuildContext context, CafeteriaState state) {
